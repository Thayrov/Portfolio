  ...
  return (
    ...
    { lang ==='en' ?
      ...
      <p className="mb-3">
        ...
        <span className="font-medium"> Node.js, React, Express y MongoDB</span>. Mi objetivo es profundizar mi 
        comprensión de <span className="font-medium">arquitectura de software, soluciones en la nube y metodologías ágiles</span>.
      </p>
      <p className="mb-3">
        Aunque esté al inicio de mi carrera como desarrollador, mis roles anteriores en 
        <span className="font-medium"> atención al cliente, ventas, enseñanza, gestión y diseño</span> me han equipado con habilidades valiosas.
        <span className="italic"> Mi habilidad para resolver problemas y gestionar conflictos</span> me permite destacar 
        en <span className="underline">entornos de trabajo en equipo</span> gracias a mis fuertes habilidades de comunicación, y buena visión para la
        <span className="font-medium"> gestión de proyectos</span>.
      </p>
      <p >
        Aporto un <span className="font-medium">conjunto de habilidades maduro y completo</span> que complementa mis habilidades técnicas, 
        convirtiéndome en un contribuyente integral para cualquier equipo. No estoy buscando simplemente un trabajo; busco <span className="font-medium">crecer, contribuir y sobresalir</span> en una posición remota a tiempo completo.
      </p>
      </>
      )}
    </motion.section>
